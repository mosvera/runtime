...
- **Field names** use `snake_case` per
  [ADR-0005](https://github.com/mosvera/spec/blob/main/docs/decisions/0005-schema-naming-conventions.md).
...
- **`$id` scheme:** https rooted at the canonical domain —
  ...
  [ADR-0014](https://github.com/mosvera/spec/blob/main/docs/decisions/0014-canonical-public-domain.md)). A stable
...
- **License:** Apache-2.0 (schemas ship inside conforming runtimes
  ...
  per [ADR-0001](https://github.com/mosvera/spec/blob/main/docs/decisions/0001-license-choice.md).
